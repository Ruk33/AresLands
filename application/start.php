...
Autoloader::map(array(
    ...
    'Admin_BattleSimulator_Controller'    => path('app').'controllers/admin/battlesimulator.php',
...
IoC::instance('Models\Achievement\AchievementRepository', new \Models\Achievement\Achievement());
IoC::instance('Models\Achievement\AchievementCharacterProgressRepository', new \Models\Achievement\AchievementCharacterProgress());