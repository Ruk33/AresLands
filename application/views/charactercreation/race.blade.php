...
<div class="text-center">
	<a href="{{ URL::to('charactercreation/create/dwarf') }}">
		<img src="/img/enano-test.png" alt="Jugar como Enano" data-toggle="tooltip" data-placement="right" data-original-title="<b>Enanos<b>" data-content=
		"<small>
	...
	<a href="{{ URL::to('charactercreation/create/elf') }}">
		<img src="/img/elfo-test.png" alt="Jugar como Elfo" data-toggle="tooltip" data-placement="left" data-original-title="<b>Elfos<b>" data-content=
		"<small>
	...
	<a href="{{ URL::to('charactercreation/create/drow') }}">
		<img src="/img/drow-test.png" alt="Jugar como Drow" data-toggle="tooltip" data-placement="right" data-original-title="<b>Drows<b>" data-content=
		"<small>
			<em><strong>Raza pura</strong></em>
	...
	<a href="{{ URL::to('charactercreation/create/human') }}">
		<img src="/img/humano-test.png" alt="Jugar como Humano" data-toggle="tooltip" data-placement="left" data-original-title="<b>Humanos<b>" data-content=
		"<small>
			<em><strong>Raza mixta</strong></em>
