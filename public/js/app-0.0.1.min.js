"use strict";angular.module("areslands.services",["configuration","ngResource"]).factory("Character",["$resource","BASE_PATH",function(e,t){return e(t+"api/character/:name/:tooltip",{},{tooltip:{method:"GET",params:{tooltip:!0}}})}]);
...
"use strict";angular.module("areslands.directives",[]).directive("dynamicTooltip",function(){return function(e,t,n){function s(e){$(t).attr("data-original-title",e).tooltip("fixTitle"),i&&$(t).tooltip("show")}var r,i=!1;e.$watch(n.dynamicTooltip,function(e){s(e)}),$(t).on("mouseover",function(){i=!0}),$(t).on("mouseout",function(){i=!1}),$(t).tooltip({html:!0,container:"#wrap"})}}).directive("characterTooltip",["Character",function(e){return function(t,n,r){var i={};i.element=$(n),i.character=null;var s=!1,o=function(e){i.element.attr("data-original-title",e).tooltip("fixTitle"),s&&i.element.tooltip("show"),i.element.unbind("mouseenter.characterTooltip").unbind("mouseleave.characterTooltip")},u=function(){s=!0,i.character||e.tooltip({name:r.characterTooltip},function(e){i.character=e.tooltip,o(e.tooltip)})},a=function(){s=!1};i.element.bind("mouseenter.characterTooltip",u),i.element.bind("mouseleave.characterTooltip",a),i.element.tooltip({html:!0,title:"Cargando...",container:"#wrap"})}}]).directive("tabs",function(){return{restrict:"E",transclude:!0,scope:{},controller:function(e,t){var n=e.panes=[];e.select=function(e){angular.forEach(n,function(e){e.selected=!1}),e.selected=!0},this.addPane=function(t){n.length==0&&e.select(t),n.push(t)}},template:'<div class="tabbable"><ul class="nav nav-tabs"><li ng-repeat="pane in panes" ng-class="{active:pane.selected}"><a href="" ng-click="select(pane)">{{pane.title}}</a></li></ul><div class="tab-content" ng-transclude></div></div>',replace:!0}}).directive("pane",function(){return{require:"^tabs",restrict:"E",transclude:!0,scope:{title:"@"},link:function(e,t,n,r){r.addPane(e)},template:'<div class="tab-pane" ng-class="{active: selected}" ng-transclude></div>',replace:!0}}).directive("appVersion",["version",function(e){return function(t,n,r){n.text(e)}}]);
